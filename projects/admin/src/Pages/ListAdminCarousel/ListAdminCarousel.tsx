...
export const ListAdminCarousel: React.FC<Props> = () => {
	...
	return (
		<>
			<PageTitle icon={<i className="fa fa-dashboard" />} title="Carroussel" subtitle="Adicione e gerencie seus carrousseis" />
			<div className="tile p-4">
				<div className="row">
					<div className="d-flex justify-content-between col-md-12">
						<div>
							<h1>Carrousseis Cadastrados</h1>
						</div>
						<div>
							<Button
								label="Adicionar"
				...
				<div className="row">
					<div className="col-md-12">
						<Table header={header} body={body} id="table-list-carousel" striped hover />
					</div>
				</div>
				<div className="row">
